        ...
        "recetas": [
            {
                "Troquel": "23523", 
                "Codigo": "23523",
                "monodroga": "EXISTENTE_A_SUSTITUIR",
                "descripcion": "MEDICAMENTO VIEJO 200 MG"
            }
        ]
    }
}
...
def agente_sustitutor(
    ...
    """
    # MOCK BYPASS: Troquel específico para prueba de sustitución
    if troquel == "23523":
        return SustitucionResponse(
            troquel=troquel,
            codigo_original="23523",
            es_sustituible=True,
            mensaje="El medicamento es sustituible. Código original '23523' se sustituye por '99999'",
            codigo_sustituto="99999"
        )
